...
interface RegistrationScreen8Props {
  onNext: (data: { livingArrangement: string }) => void;
  onBack: () => void;
}

function RegistrationScreen8({ onNext, onBack }: RegistrationScreen8Props) {
  ...
  const handleContinue = () => {
    if (selectedArrangement) {
      onNext({ livingArrangement: selectedArrangement });
    }
  };
...
export default RegistrationScreen8;
