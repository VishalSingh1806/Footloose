...
interface RegistrationScreen7Props {
  onNext: (data: { whereYouLive: string }) => void;
  onBack: () => void;
}

function RegistrationScreen7({ onNext, onBack }: RegistrationScreen7Props) {
  ...
  const handleContinue = () => {
    if (selectedOption) {
      onNext({ whereYouLive: selectedOption });
    }
  };
    ...
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col">
      ...
      <div className="flex-1 px-5 py-8 pb-28 max-w-[600px] w-full mx-auto">
        ...
        <p className="text-[15px] text-[#6C757D] mb-8">
          Do you live in the same city as your parents?
        </p>
...
export default RegistrationScreen7;
