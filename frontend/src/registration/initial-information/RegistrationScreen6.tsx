...
interface RegistrationScreen6Props {
  onNext: (data: { familyComfort: string }) => void;
  onBack: () => void;
}

function RegistrationScreen6({ onNext, onBack }: RegistrationScreen6Props) {
  ...
  const handleContinue = () => {
    if (selectedComfort) {
      onNext({ familyComfort: selectedComfort });
    }
  };
    ...
    <div className="min-h-screen bg-[#FAFAFA] flex flex-col">
      ...
      <div className="flex-1 px-5 py-8 pb-28 max-w-[600px] w-full mx-auto">
        ...
        <p className="text-[15px] text-[#6C757D] mb-8">
          How likely are your parents to accept your partner choice?
        </p>
...
export default RegistrationScreen6;
